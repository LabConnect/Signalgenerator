...
\lstinputlisting[language=C, firstline=1, lastline=15]{exp-code.c}
...
\end{tabular}
\end{center}
Es ist hierbei darauf zu achten, dass auch der Zustand des Multiplexers angepasst wird, da es ansonsten zu falschen und unerwünschten Signalen kommen kann.

\subsection{Spitzenspannung}

\pagebreak
\lstinputlisting[language=C, firstline=17, lastline=36]{exp-code.c}
